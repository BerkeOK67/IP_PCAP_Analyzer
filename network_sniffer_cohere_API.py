...
class NetSentinel:
    ...
    def _handle(self, pkt):
        ...
        src_country, src_city = self._get_geoip(src)
        # dst_country, dst_city = self._get_geoip(dst)  # Artık kullanılmıyor
        ...
        with open(self.log, "a", newline="") as f:
            csv.writer(f).writerow(
                [ts, src, dst, sp, dp, protocol, size, local, ai, src_country, src_city]
            )
